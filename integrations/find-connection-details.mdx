...
description: You connect to Tiger Cloud or self-hosted TimescaleDB using your connection details. Learn where to find them
products: [cloud, mst, self_hosted]
keywords: [connect, Managed Service for TimescaleDB, Timescale]
---

import { CLOUD_LONG, CONSOLE, MST_CONSOLE_LONG, PG, SELF_LONG, SERVICE_LONG, SERVICE_SHORT } from '/snippets/vars.mdx';
