...
import IntegrationApacheKafka from "/snippets/prerequisites/_integration-apache-kafka-install.mdx";
import OldCreateHypertable from "/snippets/prerequisites/_old-api-create-hypertable.mdx";
