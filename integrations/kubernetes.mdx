...
import { CLOUD_LONG, PGDATABASE, PGHOST, PGUSER, SERVICE_LONG, TIMESCALE_DB } from '/snippets/vars.mdx';
import KubernetesPrereqs from "/snippets/prerequisites/_kubernetes-prereqs.mdx";
import KubernetesInstallSelf from "/snippets/prerequisites/_kubernetes-install-self-hosted.mdx";
