...
import { CLOUD_LONG, CONSOLE, PG, SELF_LONG, SERVICE_LONG, SERVICE_SHORT } from '/snippets/vars.mdx';
import IntegrationPrereqsCloud from "/snippets/prerequisites/_integration-prereqs-cloud-only.mdx";
import DataDogExporter from "/snippets/prerequisites/_datadog-data-exporter.mdx";
import ManageDataExporter from "/snippets/prerequisites/_manage-a-data-exporter.mdx";
