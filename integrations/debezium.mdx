...
import { CLOUD_LONG, COMPANY, SELF_LONG, SERVICE_LONG, TIMESCALE_DB } from '/snippets/vars.mdx';
import IntegrationPrereqsSelfOnly from "/snippets/prerequisites/_integration-prereqs-self-only.mdx";
import IntegrationDebeziumDocker from "/snippets/prerequisites/_integration-debezium-docker.mdx";
import IntegrationDebeziumSelfHostedConfig from "/snippets/prerequisites/_integration-debezium-self-hosted-config-database.mdx";
