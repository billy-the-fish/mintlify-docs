...
You create a {ACCOUNT_LONG} to manage your {SERVICE_SHORT}s and data in a centralized and efficient manner in {CONSOLE}. From there, you can create and delete {SERVICE_SHORTs}, run queries, manage access and billing, integrate other services, contact support, and more.
