...
export const PRODUCTS_ALL = 'TigerData products'
...
export const CLOUD_EDITOR = 'Cloud SQL editor'; // A collective name for POPSQL and SQL editor in Console
