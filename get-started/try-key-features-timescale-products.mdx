...
import { CAGG, COMPANY, CONSOLE, ENTERPRISE, HA_REPLICA,  PRICING_PLAN, SCALE, SERVICE_LONG, SERVICE_SHORT, TIGER_POSTGRES, TIME_BUCKET, TIME_BUCKET_CAP } from '/snippets/vars.mdx';
