...
---
import { CLOUD_LONG, SERVICE_LONG, SERVICE_SHORT, TIGER_POSTGRES, HYPERCORE, PG, TIMESCALE_DB, HYPERTABLE, CHUNK, COMPANY, CONSOLE, HA_REPLICA, ROWSTORE, COLUMNSTORE, CAGG, TIME_BUCKET_CAP, TIME_BUCKET, SCALE, ENTERPRISE, PRICING_PLAN } from '/snippets/variables.mdx';
